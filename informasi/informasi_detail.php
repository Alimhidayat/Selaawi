...
$id_inf = $_GET['id_inf'];
$informasi = query("SELECT * FROM tb_informasi WHERE id_inf = $id_inf")[0];
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="page-wrapper">
                    ...
                    <div class="col">
                        <div class="about-one__content pt-0 px-0 ms-0">
                            <div class="block-title text-left">
                                ...
                                <h3 style="font-size: 32px;" class="text-center"><?=$informasi['judul_inf']?></h3>
                            </div><!-- /.block-title -->
        ...
        <div class="container">
            <div class="image" style="display: flex; justify-content: center;">
                <img src="../admin/informasi/assets/img/<?=$informasi['gambar']?>" alt="" class="img-fluid rounded" style="width: 80%;">
            </div>
