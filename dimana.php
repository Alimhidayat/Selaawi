...
<head>
    ...
    <title>Dimanakah Selaawi Itu</title>
    <!-- favicons Icons -->
    ...
    <div class="page-wrapper">
            ...
            <div class="topbar">
                <div class="container">
                    ...
                    <div class="topbar__right">
                        ...
                        <a href="#"><i class="agrikon-icon-clock"></i>Senin - Jum'at 8:00 - 16:30, Sabtu-Minggu
                            TUTUP</a>
                    </div><!-- /.topbar__right -->
                </div><!-- /.container -->
            </div><!-- /.topbar -->
                    ...
                    <div class="col">
                        <div class="about-one__content pt-0 px-0 ms-0">
                            <div class="block-title text-left">
                                ...
                                <h3 style="font-size: 32px;" class="text-center">Dimana sih Selaawi itu?</h3>
                            </div><!-- /.block-title -->
        ...
        <div class="container">
            <!-- <div class="image" style="display: flex; justify-content: center;">
                <img src="../assets/images/blog/3/62c410fae4276.jpg" alt="" class="img-fluid rounded"
                    style="width: 80%;">
            </div> -->
                    ...
                    <div class="col-lg-5">
                        <div class="about-one__content ms-0 pt-0 mt-2" style="margin-left: 0; padding-left: 10px;">
                            <div class="about-one__summery text-justify">
                                <b>Selaawi</b> adalah sebuah kecamatan di Kabupaten Garut, Provinsi Jawa Barat,
                                Indonesia.
                                Jaraknya 37 kilometer dari ibu kota Kabupaten Garut, Garut Kota. Di kecamatan ini,
                                mayoritas penduduk bekerja dalam bidang agribisnis dan perdagangan. Perlu diketahui,
                                Kecamatan Selaawi memiliki 7 desa besar dengan hasil alam yang luar biasa yaitu ;
                ...
                <div class="col">
                    <div class="about-one__content pt-0 px-0 ms-0">
                        <div class="block-title text-left">
                            <!-- <div class="block-title__image"></div>/.block-title__image -->
                            <!-- <p>Welcome to agricon</p> -->
                            <h3 style="font-size: 32px;" class="text-center">Rute Menuju Selaawi</h3>
                        </div><!-- /.block-title -->
                    </div><!-- /.about-one__content -->
                </div>
            </div><!-- /.row -->
            <div class="row mb-5 pb-5">
                <div class="google-map__home-two">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m13!1m8!1m3!1d31681.062693782016!2d107.951048!3d-6.993632!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zN8KwMDAnNDIuNCJTIDEwOMKwMDEnMDIuMCJF!5e0!3m2!1sid!2sus!4v1683447478772!5m2!1sid!2sus"
