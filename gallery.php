<?php
require "admin/album/function/functions.php";
...
<head>
    ...
    <title>Galeri BPP Selaawi</title>
    <!-- favicons Icons -->
    ...
    <link href="assets/plugin/lightbox/dist/simple-lightbox.min.css" rel="stylesheet" />

    <!-- As A Vanilla JavaScript Plugin -->
    <script src="assets/plugin/lightbox/dist/simple-lightbox.min.js"></script>
    <!-- For legacy browsers -->
    <script src="assets/plugin/lightbox/dist/simple-lightbox.legacy.min.js"></script>
    <!-- As A jQuery Plugin -->
    <script src="https://code.jquery.com/jquery-3.7.0.js" integrity="sha256-JlqSTELeR4TLqP0OG9dxM7yDPqX1ox/HfgiSLBj8+kM=" crossorigin="anonymous"></script>
    <script src="assets/plugin/lightbox/dist/simple-lightbox.jquery.min.js"></script>
    ...
    <section class="page-header">
        ...
        <section class="blog-grid pt-4">
            <div class="container">
                    ...
                    <div class="about-one__content p-0">
                        <?php $id_album = $row['id_album']?>
                        <div class="block-title text-center mb-4 mt-5">
                            <h3 style="font-size: 2rem;"><?=$row['album']?></h3>
                        </div><!-- /.block-title -->
                    </div>
                    <div class="container">
                    <div class="gallery">
                        <?php $galeri = query("SELECT * FROM tb_galeri WHERE id_album = $id_album");?>
                        <!-- <div class="row"> -->
                        <?php foreach ($galeri as $rows):?>
                                <!-- mengambil data dari galeri berdasarkan album -->
                                <!-- <div class="col-md-3"> -->
                                    <a href="admin/galeri/assets/img/<?=$rows['gambar']?>"><img src="admin/galeri/assets/img/<?=$rows['gambar']?>" title="<?=$rows['judul_gam']?>"></a>
                                <!-- </div> -->
                            <!-- /.blog-card -->
                        <?php endforeach; ?>
                        <div class="clear"></div>
