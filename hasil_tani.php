                    ...
                    <div class="col-sm-12 col-lg-10 offset-lg-1">
                        <div class="circle2">
                            <ul class="circleWrapper wStyle2">
                                ...
                                <li> 
                                    <div class="circleFeature fStyle2" data-cyrcleBox="cf<?=$i?>"><img src="admin/asset/img_komo/<?=$row['gambar']?>" alt="" style="width: 7em; height: 7em; border-radius: 50%;"> </div>
                                    <div class="circleBox innerStyle2 pt-5" id="cf<?=$i?>"><strong><?=$row['jenis_kom']?></strong><br><?=$row['jenis_kom']?>
                                        <?=$row['des_kom']?>
                                        <div class="tombol mt-3">
                                            <button type="button" class="btn btn-primary btn-sm"><a href="deskripsi_hasil.php?komoditi=<?=$row['jenis_kom']?>&id=<?=$row['id_kom']?>" style= "color: white; ">Selengkapnya</a></button>
                                        </div>
                                    </div>
                                </li>
                                <?php $i++?>
