...
<head>
    ...
    <title>Tentang Kami BPP Selawi</title>
    <!-- favicons Icons -->
...
<body>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-xl-12">
                        <div class="team-one__content">
                            <div class="block-title text-center" style="margin-bottom: 30px;">
                                <!-- <p>meet the team</p> -->
                                <h3 style="font-weight: 2rem;">Badan Penyuluhan Pertanian Selaawi</h3>
                            </div><!-- /.block-title -->
                            <p class="text-center">Badan Penyuluhan Pertanian (BPP) Selaawi Kabupaten Garut merupakan sebuah lembaga penyuluhan yang melaksanakan kegiatan penyuluhan bagi masyarakat tani di wilayah kecamatan Selaawi kabupaten Garut.</p>
                            <p class="text-center">BPP Selawi Memiliki 32 Kelompok Tani Yaitu</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12 col-lg-5 col-xl-4 offset-xl-3 offset-lg-1">
                        <div class="team-one__content text-left">
                            <ol>
                                <li>
                                    <p>Simpati Sejahtera Salawasna</p>
                                </li>
                                <li>
                                    <p>Kelompok Ternak Sapi Potong Santani</p>
                                </li>
                                <li>
                                    <p>Dudukuy Lembur</p>
                                </li>
                                ...
                                <li><p>Al-Mandiri</p></li>
                                <li><p>Kelompok Ternak Sapi Potong Pesat 1</p></li>
                                <li><p>Berkah Jaya</p></li>
                                <li><p>Taruna Tani Caringin</p></li>
                                <li><p>Selaawi 3</p></li>
                                <li><p>KWT Dahlia</p></li>
                                <li><p>Selaawi Ii</p></li>
                                <li><p>Angsana</p></li>
                                <li><p>Tanjung</p></li>
                                <li><p>Cijambu</p></li>
                                <li><p>Assyifa</p></li>
                    ...
                    <div class="col-md-12 col-lg-5 col-xl-4 offset-lg-1 offset-xl-0">
                        <div class="team-one__content text-left">
                            <ol start="17">
                                <li>
                                    <p>Tanjung Mekar</p>
                                </li>
                                <li><p>KWT Anggrek</p></li>
                                <li><p>Selaawi I</p></li>
                                <li><p>Simpati</p></li>
                                <li><p>Sawargi</p></li>
                                <li><p>Cihayam</p></li>
                                <li><p>Bina Mandiri</p></li>
                                <li><p>Mekar Rahayu</p></li>
                                <li><p>Satuhu</p></li>
                                <li><p>Aglonema Cihayam</p></li>
                                <li><p>Sunda Bakti</p></li>
                                <li><p>P3A Selaawi 1</p></li>
                                <li><p>Sela Erih Bintang  9</p></li>
                                <li><p>Sumber Rizqi</p></li>
                                <li><p>Daun Muda Berkarya</p></li>
                                <li><p>Taruna Tani Motekar Salawasna</p></li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.row -->
    ...
    <div class="mobile-nav__wrapper">
        ...
        <div class="mobile-nav__content">
            ...
            <div class="logo-box">
                <a href="index.html" aria-label="logo image"><img src="assets-selawi/LogoKabupatenGarutBRU.png" width="100" alt="" /></a>
            </div>
            <!-- /.logo-box -->
